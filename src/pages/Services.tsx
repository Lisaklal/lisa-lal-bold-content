          ...
          <div className="mt-32">
            <div className="text-center mb-16 scroll-reveal">
              ...
              <p className="text-body-large max-w-2xl mx-auto text-muted-foreground">
                Simple 3-step process to transform your brand
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center scroll-reveal">
                ...
                <p className="text-muted-foreground">
                  Share raw footage, business site, images, or access for marketing via Dropbox, Google Drive, etc. Hop on a free discovery call to tell us your requirements.
                </p>
              </div>
              ...
              <div className="text-center scroll-reveal" style={{ animationDelay: '0.1s' }}>
                ...
                <h3 className="text-xl font-bold mb-4">Review & Refine</h3>
                <p className="text-muted-foreground">
                  Review the draft and suggest changes. We offer up to 10 revisions to ensure everything meets your vision perfectly.
                </p>
              </div>
              ...
              <div className="text-center scroll-reveal" style={{ animationDelay: '0.2s' }}>
                ...
                <p className="text-muted-foreground">
                  Final result will be delivered as soon as possible with all files, assets, and documentation you need.
                </p>
              </div>
            </div>
          </div>
